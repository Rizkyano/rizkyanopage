      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col justify-between space-y-16">
        ...
        <div className="flex flex-col items-start space-y-6">
          ...
          <h2 className="text-4xl sm:text-6xl md:text-7xl font-sans font-bold dark:text-white text-slate-900 tracking-tight leading-[1.05]">
            HAVE AN IDEA? <br />
            <span className="bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">LET'S COLLABORATE.</span>
          </h2>

          <p className="dark:text-slate-300 text-slate-600 text-sm sm:text-base max-w-xl font-normal leading-relaxed">Always open to discussing design engineering, 3D WebGL interactions, design systems, and innovative web architectures.</p>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            >
              ...
              <div className="pl-2 border-l dark:border-white/10 border-slate-200 text-slate-400 group-hover:text-cyan-500 transition-colors">{copied ? <Check size={14} className="text-emerald-500" /> : <Copy size={14} />}</div>
            </button>

            {copied && <span className="text-xs font-mono text-emerald-500 animate-fadeIn font-semibold">✓ Copied to clipboard!</span>}
          </div>
        </div>
