...
export const PROJECTS: Project[] = [
  {
    ...
    features: ["Pokémon & One Piece TCG catalog", "PSA & BGS authenticated graded cards", "Automated consignment & draft system", "Instant cart management & WhatsApp checkout"],
  ...
  },
  {
    ...
    features: ["Automated GL double-entry journal audit trail", "ACID ledger compliant transaction engine", "Real-time inventory & low-stock alerts", "Interactive financial cash flow & revenue analytics"],
  ...
  },
  {
    ...
    features: ["Domestic & international destination exploration", "Interactive tour packages & booking system", "Comprehensive educational travel guides", "Ultra-responsive modern travel interface"],
